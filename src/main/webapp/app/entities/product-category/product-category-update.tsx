  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="vshopApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="vshopApp.productCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('vshopApp.productCategory.name')}
              ...
              />
              <ValidatedField
                label={translate('vshopApp.productCategory.description')}
