...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="vshopApp.productCategory.delete.question">
        <Translate contentKey="vshopApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
