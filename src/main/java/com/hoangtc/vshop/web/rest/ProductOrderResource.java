...
/**
 * REST controller for managing {@link com.hoangtc.vshop.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
public class ProductOrderResource {
    ...
    public ResponseEntity<ProductOrder> updateProductOrder(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, productOrder.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ProductOrder> partialUpdateProductOrder(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, productOrder.getId())
        );
    }
