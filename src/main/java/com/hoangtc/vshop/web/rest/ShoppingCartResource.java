...
import com.hoangtc.vshop.service.ShoppingCartService;
...
/**
 * REST controller for managing {@link com.hoangtc.vshop.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
public class ShoppingCartResource {
    ...
    public ResponseEntity<ShoppingCart> updateShoppingCart(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, shoppingCart.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ShoppingCart> partialUpdateShoppingCart(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, shoppingCart.getId())
        );
    }
