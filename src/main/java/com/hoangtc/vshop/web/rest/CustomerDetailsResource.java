...
import com.hoangtc.vshop.service.CustomerDetailsService;
...
/**
 * REST controller for managing {@link com.hoangtc.vshop.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
public class CustomerDetailsResource {
    ...
    public ResponseEntity<CustomerDetails> updateCustomerDetails(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, customerDetails.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<CustomerDetails> partialUpdateCustomerDetails(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, customerDetails.getId())
        );
    }
    ...
    public ResponseEntity<CustomerDetails> getCustomerDetails(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteCustomerDetails(@PathVariable String id) {
